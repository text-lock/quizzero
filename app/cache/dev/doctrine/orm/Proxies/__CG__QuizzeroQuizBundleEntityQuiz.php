 ...
 */
class Quiz extends \Quizzero\QuizBundle\Entity\Quiz implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'body', 'image', 'questions', 'results', 'created_at', 'updated_at'];
        }
